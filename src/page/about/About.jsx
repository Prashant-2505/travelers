  ...
  return (
    <div className='mainAbout'>
      ...
      <div className="aboutData">
        <h1>Our history</h1>
        <p>Travelers is owned and managed by Travelses.in Pvt.Ltd. a leading brand in web desgining services and e-commerce solutions. Travelers. in Pvt. Ltd. is counted for its expertise in Web Solutions and its top ranking buisness portals. Our invincible and rich experience has raised our spirits to reach ahead from our clients expectation. Commendable success rate of other portals manged by Travelers is a live program of our work excellence</p>
